...
public class ScaleSetupViewModel(AuthedHttpClient httpClient) : BaseNotifyStateChanged, IScaleSetupViewModel  
{
	...
	public async Task ScanForDevices()
	{
		...
		Scanning = true;
		Task<HttpResponseMessage> task = httpClient.PutAsJsonAsync<object>("scale", this);
